...
export class SectionService {
  ...
  private loadBookMarks(): void {
    this.httpClient
      .get<Section[]>(this.urlService.getGetSectionsUrl())
      .pipe(first())
  ...
  public createSection(title: string): Observable<Section> {
    ...
    return this.httpClient
      .post<Section>(this.urlService.getPostSectionsUrl(), body)
      .pipe(
        first(),
        tap((value) => {
  ...
  public updateSection(
    ...
    return this.httpClient
      .put<Section>(this.urlService.getPutSectionsUrl(sectionUuid), body)
      .pipe(
        first(),
        tap((sectionFromBackend) => {
          this.sections.next([
            ...this.sections.value.filter(
  ...
  public deleteSection(sectionUuid: string): Observable<void> {
    return this.httpClient
      .delete<void>(this.urlService.getDeleteSectionsUrl(sectionUuid))
      .pipe(
        first(),
        tap((_) => {
          this.sections.next([
