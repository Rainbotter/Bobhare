...
export class GroupService {
  ...
  public createGroup(
    ...
    return this.httpClient
      .post<Group>(this.urlService.getPostGroupUrl(section.uuid), body)
      .pipe(
        first(),
        tap((value) => {
  ...
  public updateGroup(
    ...
    return this.httpClient
      .put<Group>(this.urlService.getPutGroupUrl(section.uuid, groupUuid), body)
      .pipe(
        first(),
        tap((groupromBackend) => {
          section.groups = [
            ...section.groups.filter((group) => group.uuid !== groupUuid),
            groupromBackend,
          ];
        }),
      );
  ...
  public deleteGroup(section: Section, groupUuid: string): Observable<void> {
    ...
    return this.httpClient
      .delete<void>(this.urlService.getDeleteGroupUrl(section.uuid, groupUuid))
      .pipe(
        first(),
        tap((_) => {
          section.groups = [
